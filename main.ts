...
function establecerAyudante () {
    mySprite2 = sprites.create(assets.image`Ayudante`, SpriteKind.Ayudante)
    mySprite2.ay = 0
    mySprite3 = sprites.create(assets.image`Ayudante2`, SpriteKind.Ayudante)
    mySprite3.ay = 300
}
...
game.onUpdate(function () {
    ...
    mySprite3.setImage(assets.image`Ayudante2`)
    direccion = 1
    if (mySprite.vx == 0) {
    ...
    if (mySprite.vy < 0) {
        ...
        mySprite.setImage(assets.image`Fall`)
...
game.onUpdate(function () {
    mySprite2.setPosition(mySprite2.x + (mySprite.x - 15 - mySprite2.x) / 5, mySprite2.y + (mySprite.y - 25 - mySprite2.y) / 5)
    mySprite3.vx = (mySprite.x - direccion * 15 - mySprite3.x) * 9
})
